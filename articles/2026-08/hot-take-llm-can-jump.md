...
Going beyond the case study of Tom’s work, I believe the essence is whether LLMs can come up with plausible explanations that enable breakthroughs. I agree with Tom’s argument that Schmidhuber’s perspective of _[compression](https://link.springer.com/chapter/10.1007/978-3-642-02565-5_4)_, which is “the search for a simple program that concisely explains observations” would not unlock the abductive jump (read: come up with plausible hypothesis).
